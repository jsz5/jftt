...
{
  "$end", "error", "$undefined", "NUM", "LEFT_BRACKET", "RIGHT_BRACKET",
  "END", "ERROR", "SUBSTRACT", "ADD", "MULTIPLY", "DIVIDE", "MOD", "POWER",
  "MINUS", "$accept", "input", "line", "stmt", YY_NULLPTR
};
#endif
...
{
     -13,    24,   -13,    -1,   -13,     0,   -13,     0,   -13,    25,
     -13,    10,   -13,   -13,     0,     0,     0,     0,     0,     0,
     -13,    29,    29,   -12,   -12,   -12,   -12
};
...
{
      11,    19,    12,     4,     5,    10,     0,     0,     7,    21,
      22,    23,    24,    25,    26,    20,     0,     0,    14,    15,
      16,    17,    18,    19,     2,     3,     0,     4,     5,     0,
       6,    13,     7,    14,    15,    16,    17,    18,    19,    16,
      17,    18,    19
};

static const yytype_int8 yycheck[] =
{
       5,    13,     7,     3,     4,     6,    -1,    -1,     8,    14,
      15,    16,    17,    18,    19,     5,    -1,    -1,     8,     9,
      10,    11,    12,    13,     0,     1,    -1,     3,     4,    -1,
       6,     6,     8,     8,     9,    10,    11,    12,    13,    10,
      11,    12,    13
};
...
{
       0,    16,     0,     1,     3,     4,     6,     8,    17,    18,
       6,    18,    18,     6,     8,     9,    10,    11,    12,    13,
       5,    18,    18,    18,    18,    18,    18
};
...
#line 64 "calculator.ypp" /* yacc.c:1646  */
    {
                          reverseNotation += "/ ";
                          if ((yyvsp[0].number) != 0)
                            (yyval.number) = divide((yyvsp[-2].number),(yyvsp[0].number));
                          else
...
#line 71 "calculator.ypp" /* yacc.c:1646  */
    {
                          reverseNotation += "% ";
                          if ((yyvsp[0].number) != 0)
                            (yyval.number) = (yyvsp[-2].number)-divide((yyvsp[-2].number),(yyvsp[0].number))*(yyvsp[0].number);
                          else
                            yyerror ("dzielenie przez 0");
                        }
